...
public class ChunkServer3 implements  VoidFunctionPtr
{   
	public ChunkServer3() {
		System.out.println("ChunkServer 3 started as Server!");
	...
	public void call(Object pArg){
		...
		try {
			...
			*/
			...
			Logger.getLogger(ChunkServer3.class.getName()).log(Level.SEVERE, null, ex);
		}       
		finally {
				try {
