...
public class ChunkServer5 implements  VoidFunctionPtr
{   
	public ChunkServer5() {
		System.out.println("ChunkServer 5 started as Server!");
	...
	public void call(Object pArg){
		...
		try {
			...
			*/
			...
			Logger.getLogger(ChunkServer5.class.getName()).log(Level.SEVERE, null, ex);
		}       
		finally {
				try {
