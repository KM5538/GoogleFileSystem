...
public class ChunkServer1 implements  VoidFunctionPtr
{   
	public ChunkServer1() {
		System.out.println("ChunkServer 4 started as Server!");
	...
	public void call(Object pArg){
		...
		try {
			...
			*/
			...
			Logger.getLogger(ChunkServer1.class.getName()).log(Level.SEVERE, null, ex);
		}       
		finally {
				try {
